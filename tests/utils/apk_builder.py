...
def create_minimal_native_apk(
    apk_path: Path, package_name: str = "com.test.minimal", native_libs: list[str] = None, permissions: list[str] = None
) -> None:
...
def create_flutter_test_apk(apk_path: Path, package_name: str = "com.test.flutter") -> None:
