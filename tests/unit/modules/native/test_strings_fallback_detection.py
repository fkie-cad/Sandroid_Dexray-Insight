...
class TestStringsFallbackDetectionModule:
    ...
    def config(self):
        ...
        return {"enabled": True, "min_confidence": 0.6, "max_libraries_per_binary": 10, "strings_timeout": 30}
    ...
    def test_initialization_no_strings_command(self, config, mock_logger):
        ...
        with patch("shutil.which", return_value=None):
            ...
            mock_logger.warning.assert_called_with(
                "strings command not available - strings fallback detection disabled"
            )
    ...
    def test_analyze_binary_success(self, mock_run, fallback_module, binary_info):
        ...
        mock_result.returncode = 0
        mock_result.stdout = (
            "--prefix=/home/peter/projs/ffmpeg/FFmpeg-n4.1.3/build\nFFmpeg version n4.1.3\nother string"
        )
        mock_run.return_value = mock_result
...
class TestStringsFallbackIntegration:
    ...
    def test_real_strings_command(self):
        ...
        try:
            ...
            result = subprocess.run(["strings", "-n", "4", "-a", temp_path], capture_output=True, text=True, timeout=10)
