...
from src.dexray_insight.core.base_classes import BaseAnalysisModule
from src.dexray_insight.core.base_classes import BaseResult
from src.dexray_insight.core.base_classes import register_module
...
class TestBaseResult:
    ...
    def test_base_result_creation(self):
        ...
        result = BaseResult(module_name="test_module", status=AnalysisStatus.SUCCESS, execution_time=1.5)
    ...
    def test_base_result_to_dict(self):
        ...
        result = BaseResult(
            module_name="test_module", status=AnalysisStatus.SUCCESS, execution_time=1.5, error_message=None
        )
...
class TestAnalysisContext:
    ...
    def test_analysis_context_shared_data(self):
        ...
        context = AnalysisContext(apk_path="/test/app.apk", config={})
...
class MockAnalysisModule(BaseAnalysisModule):
    ...
    def analyze(self, apk_path: str, context: AnalysisContext) -> BaseResult:
        ...
        return BaseResult(module_name="mock_module", status=AnalysisStatus.SUCCESS, execution_time=0.1)
