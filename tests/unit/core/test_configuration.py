...
class TestConfiguration:
    ...
    def test_configuration_with_yaml_file(self):
        ...
        test_config = {
            ...
            "external_tools": {"apktool_enabled": True, "jadx_enabled": False},
            "api_keys": {"virustotal": "test_key_123"},
        }
    ...
    def test_configuration_with_kwargs(self, test_config):
        ...
        config.update_from_kwargs(do_signature_check=True, is_verbose=True, do_sec_analysis=True)
    ...
    def test_configuration_merge(self):
        ...
        config1 = {"modules": {"signature_detection": {"enabled": True}}}

        config2 = {"modules": {"string_analysis": {"enabled": True}}}
