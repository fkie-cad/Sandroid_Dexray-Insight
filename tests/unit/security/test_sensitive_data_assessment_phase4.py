...
class TestSensitiveDataAssessmentBasicConfiguration:
    ...
    def test_initialize_basic_configuration_sets_core_attributes(self):
        ...
        # Arrange
        config = {"pii_patterns": ["email", "phone"], "crypto_keys_check": True}
...
class TestSensitiveDataAssessmentPatternConfiguration:
    ...
    def test_setup_pattern_enablement_configures_enabled_patterns(self):
        ...
        # Arrange
        config = {
            "key_detection": {"enabled": True, "patterns": {"pem_keys": False, "api_keys": True, "jwt_tokens": True}}
        }
        assessment = SensitiveDataAssessment.__new__(SensitiveDataAssessment)
...
class TestSensitiveDataAssessmentThresholdConfiguration:
    ...
    def test_initialize_threshold_configuration_sets_entropy_thresholds(self):
        ...
        config = {
            "key_detection": {
                "entropy_thresholds": {"min_base64_entropy": 5.0, "min_hex_entropy": 4.0},
                "length_filters": {"min_key_length": 20, "max_key_length": 256},
                "context_detection": {"enabled": False, "strict_mode": True},
            }
        }
        assessment = SensitiveDataAssessment.__new__(SensitiveDataAssessment)
...
class TestSensitiveDataAssessmentCriticalPatterns:
    ...
    def test_setup_critical_security_patterns_aws_key_detection(self):
        ...
        assert re.search(aws_pattern, "AKIAIOSFODNN7EXAMPLE") is not None  # pragma: allowlist secret
        assert re.search(aws_pattern, "AKIA1234567890123456") is not None  # pragma: allowlist secret
...
class TestSensitiveDataAssessmentHighMediumPatterns:
    ...
    def test_setup_high_medium_severity_patterns_creates_patterns(self):
        ...
        medium_patterns = ["mongodb_uri", "postgresql_uri", "ssh_public_key", "hex_key_256"]
    ...
    def test_setup_high_medium_patterns_jwt_token_detection(self):
        ...
        test_jwt = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ"  # pragma: allowlist secret
...
class TestSensitiveDataAssessmentLowSeverityPatterns:
    ...
    def test_setup_low_severity_context_patterns_creates_patterns(self):
        ...
        low_patterns = ["jenkins_api_token", "base64_key_long", "high_entropy_string", "s3_bucket_url"]
...
class TestSensitiveDataAssessmentLegacyCompatibility:
    ...
    def test_setup_legacy_compatibility_creates_legacy_patterns(self):
        ...
        expected_permissions = ["READ_CONTACTS", "CAMERA", "ACCESS_FINE_LOCATION", "RECORD_AUDIO"]
...
class TestSensitiveDataAssessmentRefactoredInit:
    ...
    def test_refactored_init_calls_all_initialization_functions(self):
        ...
        with patch.object(SensitiveDataAssessment, "_initialize_basic_configuration") as mock_basic, patch.object(
            SensitiveDataAssessment, "_setup_pattern_enablement"
        ) as mock_patterns, patch.object(
            SensitiveDataAssessment, "_initialize_threshold_configuration"
        ) as mock_thresholds, patch.object(SensitiveDataAssessment, "_compile_pii_patterns") as mock_pii, patch.object(
            SensitiveDataAssessment, "_setup_critical_security_patterns"
        ) as mock_critical, patch.object(
            SensitiveDataAssessment, "_setup_high_medium_severity_patterns"
        ) as mock_high_med, patch.object(
            SensitiveDataAssessment, "_setup_low_severity_context_patterns"
        ) as mock_low, patch.object(SensitiveDataAssessment, "_setup_legacy_compatibility") as mock_legacy:
    ...
    def test_refactored_init_maintains_functionality_compatibility(self):
        ...
        config = {
            ...
            "key_detection": {"enabled": True, "patterns": {"pem_keys": False, "api_keys": True}},
        }
