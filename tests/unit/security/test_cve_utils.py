...
from src.dexray_insight.security.cve.models.library_mapping import LibraryMapping
from src.dexray_insight.security.cve.models.library_mapping import LibraryNameMapper
from src.dexray_insight.security.cve.models.vulnerability import AffectedLibrary
...
from src.dexray_insight.security.cve.models.vulnerability import VersionRange
from src.dexray_insight.security.cve.utils.cache_manager import CVECacheManager
from src.dexray_insight.security.cve.utils.rate_limiter import APIRateLimiter
...
class TestAPIRateLimiter:
    ...
    def basic_config(self):
        ...
        return RateLimitConfig(requests_per_minute=60, requests_per_hour=3600, burst_limit=10, burst_window_seconds=60)

    @pytest.fixture
    def strict_config(self):
        """Strict rate limit configuration for testing"""
        return RateLimitConfig(requests_per_minute=2, requests_per_hour=10, burst_limit=1, burst_window_seconds=30)
...
class TestCVECacheManager:
    ...
    def test_cache_expiry(self, cache_manager, sample_vulnerabilities):
        ...
        short_cache = CVECacheManager(cache_dir=cache_manager.cache_dir, cache_duration_hours=0)  # Immediate expiry
...
class TestVulnerabilityModels:
    ...
    def test_version_range_creation(self):
        ...
        version_range = VersionRange(introduced="1.0.0", fixed="2.0.0", last_affected="1.9.9")
    ...
    def test_cve_vulnerability_creation(self):
        ...
        affected_lib = AffectedLibrary(name="test-library", ecosystem="Maven", version_ranges=[])
