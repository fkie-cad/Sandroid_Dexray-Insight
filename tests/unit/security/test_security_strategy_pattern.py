...
from dexray_insight.core.base_classes import SecurityFinding
...
class TestStringCollectionStrategy:
    ...
    def mock_analysis_results(self):
        ...
        return {
            "string_analysis": {
                ...
                "android_properties": {"api.key": "sk_test_12345", "debug.enabled": "true"},
    ...
    def test_collect_strings_handles_object_with_to_dict(self, strategy):
        ...
        mock_string_result.to_dict.return_value = {"emails": ["mock@test.com"], "urls": ["https://mock.api"]}
...
class TestDeepAnalysisStrategy:
    ...
    def mock_existing_strings(self):
        ...
        return [{"value": "existing_string", "location": "test", "file_path": None, "line_number": None}]
    ...
    def test_extract_deep_strings_with_deep_analysis_mode(self, strategy, mock_existing_strings):
        ...
        mock_behaviour_results.androguard_objects = {"mode": "deep", "apk_obj": Mock(), "dex_obj": [Mock()]}
...
class TestPatternDetectionStrategy:
    ...
    def mock_detection_patterns(self):
        ...
        return {
            "api_keys": {"pattern": r"sk_[a-zA-Z0-9]{24}", "severity": "HIGH"},
            "aws_keys": {"pattern": r"AKIA[0-9A-Z]{16}", "severity": "CRITICAL"},
        }
...
class TestFindingGenerationStrategy:
    ...
    def mock_classified_results(self):
        ...
        return {
            "findings": {
                ...
                "high": ["🔑 [HIGH] API Key: sk_test_1234567890123456789012 (found in MainActivity.java:42)"],
                "medium": [
                    "🔑 [MEDIUM] Database URL: postgresql://user:pass@localhost/db (found in config.properties)"
                ],
                "low": ["🔑 [LOW] S3 URL: https://mybucket.s3.amazonaws.com (found in strings.xml)"],
            },
            "secrets": {
    ...
    def test_generate_findings_with_empty_classifications(self, strategy):
        ...
        # Arrange
        sparse_results = {
            "findings": {"critical": ["🔑 [CRITICAL] Test finding"], "high": [], "medium": [], "low": []},
            "secrets": {"critical": [{"type": "Test"}], "high": [], "medium": [], "low": []},
        }
...
class TestSecurityStrategyIntegration:
    ...
    def test_complete_strategy_workflow_integration(self):
        ...
        config = {
            ...
            "key_detection_config": {"enabled": True, "patterns": ["aws", "github", "stripe"]},
        }
