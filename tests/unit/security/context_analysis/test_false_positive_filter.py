...
class TestFalsePositiveFilter:
    ...
    def test_is_placeholder_value_real_keys(self, filter_instance):
        ...
        real_keys = [
            "AIzaSyDRKQ9d6kfsoZT2lUnZcZnBYvH69HExNPE",  # Real Google API key format  # pragma: allowlist secret
            "sk_live_51HyMz2LkdIwHu7ix1Hm8g2fvNx8K",  # Real Stripe key format  # pragma: allowlist secret
            "ghp_1234567890abcdef1234567890abcdef12345678",  # Real GitHub token format  # pragma: allowlist secret
            "AKIAIOSFODNN7EXAMPLE1234567890ABCDEF",  # Real AWS key format  # pragma: allowlist secret
        ]
    ...
    def test_calculate_entropy_high_entropy_strings(self, filter_instance):
        ...
        high_entropy_strings = [
            ...
            "sk_live_51HyMz2LkdIwHu7ixHm8g2fvNx8K",  # Stripe key  # pragma: allowlist secret
    ...
    def test_calculate_entropy_low_entropy_strings(self, filter_instance):
        ...
        low_entropy_strings = ["test_api_key", "your_key_here", "1111111111111111", "aaaaaaaaaaaaaaaa", "password123"]
    ...
    def test_has_high_entropy_positive_cases(self, filter_instance):
        ...
        high_entropy_strings = [
            "AIzaSyDRKQ9d6kfsoZT2lUnZcZnBYvH69HExNPE",
            "3c9e4b5f7a8d2e1c6b9a5f8e2d1c4b7a9e6f3c8d",  # pragma: allowlist secret
    ...
    def test_get_false_positive_indicators_placeholder(self, filter_instance):
        ...
        finding = {"value": "YOUR_API_KEY_HERE", "type": "Generic API Key", "location": "configuration"}
    ...
    def test_get_false_positive_indicators_test_context(self, filter_instance):
        ...
        finding = {"value": "test_secret_key_12345", "type": "Generic Secret", "location": "test file"}

        code_context = CodeContext(file_path="/app/src/test/java/ApiTest.java", class_names={"ApiTest"})
    ...
    def test_get_false_positive_indicators_low_entropy(self, filter_instance):
        ...
        finding = {"value": "test_key_123456", "type": "Potential key", "location": "source code"}
