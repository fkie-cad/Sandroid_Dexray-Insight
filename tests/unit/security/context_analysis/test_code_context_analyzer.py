...
class TestCodeContextAnalyzer:
    ...
    def sample_behavior_analysis(self):
        ...
        return {"androguard_objects": {"mode": "deep", "apk_obj": Mock(), "dex_obj": [Mock()]}}
    ...
    def test_analyze_string_context_xml_location(self, analyzer):
        ...
        analysis_results = {
            ...
            "behaviour_analysis": {"deep_analysis": {"strings": []}},
        }
    ...
    def test_determine_location_type_build_files(self, analyzer):
        ...
        build_files = ["/app/build.gradle", "/app/app/build.gradle", "/app/gradle.properties", "/app/settings.gradle"]
    ...
    def test_parse_java_like_code_comment(self, analyzer):
        ...
        code_lines = ["// This is a single line comment", "/* Multi-line comment */", "* Documentation comment"]
    ...
    def test_detect_protection_level_no_protection(self, analyzer):
        ...
        context_plain = CodeContext(surrounding_lines=['String apiKey = "plain_text_key";'], variable_names={"apiKey"})
    ...
    def test_enhance_context_with_behavior_analysis_fast_mode(self, analyzer):
        ...
        behavior_analysis = {"androguard_objects": {"mode": "fast"}}
    ...
    def test_analyze_string_context_comprehensive_integration(self, analyzer, sample_string_data):
        ...
        analysis_results = {
            ...
            "behaviour_analysis": {"androguard_objects": {"mode": "fast"}},
        }
    ...
    def test_edge_case_missing_analysis_results(self, analyzer):
        ...
        finding = {"value": "test_key", "location": "unknown"}
