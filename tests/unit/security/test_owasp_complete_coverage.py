...
class TestOWASPTopTenCompleteCoverage:
    ...
    def mock_analysis_results(self):
        ...
        return {
            "manifest_analysis": {
                ...
                "debug_flags": {"debuggable": True, "allow_backup": True, "test_only": False},
            ...
            "api_invocation": {
                ...
                "reflection_usage": ['Class.forName("java.lang.Runtime")', "Method.invoke(dynamicMethod, userInput)"],
                "crypto_usage": [
                    {"algorithm": "MD5", "context": "Password hashing", "location": "AuthManager.java:45"},
                    {"algorithm": "DES", "context": "Data encryption", "location": "CryptoHelper.java:23"},
                ],
            },
            "behaviour_analysis": {
            ...
            "native_analysis": {
                ...
                "binary_analysis": {"stack_protection": False, "position_independent": False, "stripped_symbols": True},
            },
        }
    ...
    def test_a04_insecure_design_assessment_findings(self, mock_analysis_results):
        ...
        expected_patterns = ["Insecure Data Flow Design", "Missing Security Controls", "Weak Cryptographic Design"]

        # At least one design flaw should be detected
        assert any(any(pattern in title for pattern in expected_patterns) for title in finding_titles)
    ...
    def test_a04_insecure_design_assessment_handles_non_list_strings(self):
        ...
        analysis_results_with_bool = {
            "string_analysis": {"all_strings": True},  # This was causing the 'bool' object is not iterable error
    ...
    def test_mobile_specific_assessment_platform_misuse(self, mock_analysis_results):
        ...
        mobile_findings = [
            f
            for f in findings
            if any(keyword in f.title.lower() for keyword in ["mobile", "storage", "communication", "platform"])
        ]
