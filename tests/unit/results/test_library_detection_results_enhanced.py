...
class TestDetectedLibraryEnhanced(unittest.TestCase):
    ...
    def test_format_version_output_without_version(self):
        ...
        library = DetectedLibrary(name="Unknown Library", detection_method=LibraryDetectionMethod.PATTERN_MATCHING)
    ...
    def test_post_init_new_fields(self):
        ...
        library = DetectedLibrary(name="Test Library", detection_method=LibraryDetectionMethod.HEURISTIC)
