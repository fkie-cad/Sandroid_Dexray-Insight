...
class TestFindingAttributeAccessFixes:
    ...
    def test_safe_get_finding_attribute_with_dictionary(self):
        ...
        assert (
            results._safe_get_finding_attribute(finding_dict, "description")
            == "Application uses libraries with critical CVE vulnerabilities"
        )
            ...
            "findings": [
                {
                    ...
                    "severity": "CRITICAL",
                    "additional_data": {
                        "cve_library_mapping": {"FFmpeg": ["CVE-2019-17539", "CVE-2019-17542"]},
                        "detailed_cves": [
                            {
                ...
                },
                {
                    ...
                    "additional_data": {
                        "complete_cve_mapping": {
                            ...
                            "library_summary": {"FFmpeg": {"critical": 2, "high": 8, "medium": 10, "low": 2}},
                            "total_cves": 22,
            ...
            "findings": [
                {
                    "title": "CVE Vulnerability Scan Summary",
                    "category": "CVE Vulnerability Scanning",
                    "evidence": ["Total CVE vulnerabilities found: 5", "Critical: 0, High: 2, Medium: 2, Low: 1"],
                }
            ]
        }
...
class TestCVEAssessmentFixes:
    ...
    def test_cve_library_mapping_creation(self):
        ...
        from dexray_insight.security.cve.models.vulnerability import AffectedLibrary
        from dexray_insight.security.cve.models.vulnerability import CVESeverity
        from dexray_insight.security.cve.models.vulnerability import CVEVulnerability
        from dexray_insight.security.cve_assessment import CVEAssessment
        ...
        library_lookup = {"FFmpeg": {"name": "FFmpeg", "version": "4.1.3", "detection_method": "native_analysis"}}
