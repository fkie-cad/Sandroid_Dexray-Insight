...
class TestLibraryDetectionVersionAnalysisIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = {
            ...
            "version_analysis": {"enabled": True, "api_timeout": 2, "console_output": {"enabled": True}},
        }
    ...
    def _create_mock_apktool_files(self, mock_glob):
        ...
        mock_properties = [Mock(spec=Path), Mock(spec=Path), Mock(spec=Path)]
        ...
        def mock_open_side_effect(file_path, mode="r", encoding=None):
            ...
            if "play-services-cast" in str(file_path):
                ...
                mock_file.__enter__.return_value.__iter__.return_value = ["version=2.2.0\n", "client=core-common\n"]
            return mock_file
    ...
    def test_androidx_detection_with_version_analysis(self, mock_is_dir, mock_exists, mock_rglob, mock_open):
    ...
    def test_version_analysis_integration(self, mock_requests):
        ...
        mock_response.json.return_value = {
            "response": {"docs": [{"latestVersion": "25.0.0", "timestamp": 1609459200000}]}  # 2021-01-01
        }
    ...
    def test_version_analysis_display_order(self):
        ...
        self.assertIn(
            "_print_version_analysis_results",
            source,
