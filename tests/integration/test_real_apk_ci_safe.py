...
from tests.fixtures.real_apk_fixtures import androguard_obj_factory  # noqa: F401
from tests.fixtures.real_apk_fixtures import apk_test_validator  # noqa: F401
...
from tests.fixtures.real_apk_fixtures import performance_tracker  # noqa: F401
...
class TestRealAPKCISafe:
    ...
    def test_complete_analysis_pipeline(
        self,
        ci_safe_apk_path,
        real_apk_test_config,
        performance_tracker,
        apk_test_validator,
        mock_external_apis,
        androguard_obj_factory,
    ):
        """
        ...
        performance_errors = apk_test_validator.validate_performance_metrics(results_dict, max_duration=max_duration)
        ...
        print(
            f"Analysis completed in {perf_summary['duration']:.2f}s for {perf_summary['metrics']['apk_size_mb']:.1f}MB APK"
        )

    def test_all_modules_integration(
        self, ci_safe_apk_path, real_apk_test_config, mock_external_apis, androguard_obj_factory
    ):
        """
        ...
        assert (
            "strings_ip" in in_depth
            or "strings_urls" in in_depth
            or "strings_emails" in in_depth
            or "strings_domain" in in_depth
    ...
    def test_json_output_format_compliance(
        self, ci_safe_apk_path, real_apk_test_config, mock_external_apis, androguard_obj_factory
    ):
        """
    ...
    def test_console_output_formatting(
        self, ci_safe_apk_path, real_apk_test_config, mock_external_apis, capsys, androguard_obj_factory
    ):
        """
        ...
        assert (
            "Analysis completed" in output or "detected" in output.lower()
    ...
    def test_error_handling_and_resource_management(
        self, ci_safe_apk_path, real_apk_test_config, mock_external_apis, androguard_obj_factory
    ):
        """
        ...
        try:
            ...
            if invalid_results is not None:
                ...
                assert (
                    "errors" in results_dict or "error_message" in results_dict
    ...
    def test_performance_benchmarking(
        self, ci_safe_apk_path, real_apk_test_config, performance_tracker, mock_external_apis, androguard_obj_factory
    ):
        """
        ...
        assert (
            avg_duration < max_allowed_duration
...
class TestRealAPKModuleSpecific:
    ...
    def test_library_detection_real_apk(
        self, ci_safe_apk_path, real_apk_test_config, mock_external_apis, androguard_obj_factory
    ):
    ...
    def test_tracker_analysis_real_apk(
        self, ci_safe_apk_path, real_apk_test_config, mock_external_apis, androguard_obj_factory
    ):
    ...
    def test_string_analysis_real_apk(
        self, ci_safe_apk_path, real_apk_test_config, mock_external_apis, androguard_obj_factory
    ):
