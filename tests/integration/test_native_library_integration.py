...
class TestNativeLibraryIntegration:
    ...
    def native_config(self):
        ...
        return {
            "modules": {
                "library_version_detection": {"enabled": True, "min_confidence": 0.6, "max_libraries_per_binary": 10},
                "string_extraction": {"enabled": True, "min_string_length": 4},
            },
            ...
            "native_libraries": [
                {
                    ...
                    "additional_info": {"source_type": "prefix", "architecture": "arm64-v8a", "native_detection": True},
                },
                {
                    "name": "OpenSSL",
                    "version": "1.1.1g",
