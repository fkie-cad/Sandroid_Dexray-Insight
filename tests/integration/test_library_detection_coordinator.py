...
class TestApktoolDetectionEngineCoordinatorIntegration(unittest.TestCase):
    ...
    @patch(
        "src.dexray_insight.modules.library_detection.engines.apktool_detection_engine.ApktoolDetectionEngine._load_library_definitions"
    )
    def test_detect_libraries_orchestration(self, mock_load_defs):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with open(buildconfig_file, "w") as f:
                f.write(
                    """.class public final Lcom/test/BuildConfig;
